        ...
        for (const buildOption of Object.keys(options)) {
            if (validBuildOptions.has(buildOption)) {
                ...
                if (['css', 'html', 'js'].indexOf(prefix) !== -1) {
                    ...
                    buildOptions[this.dashToCamelCase(buildOption)] =
                        options[buildOption];
                }
            }
        }
    ...
    run(options, config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (config.builds) {
                ...
                promises.push(mzfs.writeFile(path.join(mainBuildDirectoryName, process.env.POLYMER_JSON || 'polymer.json'), config.toJSON()));
